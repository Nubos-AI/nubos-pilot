...
const KNOWLEDGE_CANDIDATES = [
  path.resolve(SOURCE_ROOT, '..', 'docs', 'v1'),
  path.resolve(SOURCE_ROOT, '..', '..', 'knowledge', 'libraries', 'nubos-pilot', 'v1'),
];
const KNOWLEDGE_ROOT = KNOWLEDGE_CANDIDATES.find((dir) => fs.existsSync(dir)) || KNOWLEDGE_CANDIDATES[1];
